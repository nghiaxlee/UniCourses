...
//Start = map hd [[1, 2, 3], [3, 4], [5, 7, 8, 9]]
...
//Start = map tl [[1, 2, 3], [3, 4], [5, 7, 8, 9]]
//Start = map (drop 1) [[1, 2, 3], [3, 4], [5, 7, 8, 9]]
...
//Start = map (\x = x*3) [1..5] // \x = lambda expr x
//Start = map ((*)3) [1..5]
...
//lastdigits [x : xs] = map (x rem 10) [x : xs]
...
ins0 :: [[Int]] -> [[Int]]
ins0 x = map ((++)[0]) x // When compile will be [0] ++ 
